...
import logoTwig from './text/logo.twig';
import watchvideoTwig from './text/watch-video.twig';
import headTwig from './headings/head.twig';

import blockquoteData from './text/blockquote.yml';
import headingData from './headings/headings.yml';
import logoData from './text/logo.yml';
import headData from './headings/head.yml';
...
export const watchvideotext = () => watchvideoTwig();

export const head = () => headTwig(headData);
